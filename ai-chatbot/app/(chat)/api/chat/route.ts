...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Send query directly to RAG system
    try {
      const ragResponse = await fetch(`${RAG_API_URL}/chat-query`, {
        method: 'POST',
        headers: {
